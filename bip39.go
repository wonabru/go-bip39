...
func MnemonicToByteArray(mnemonic string) ([]byte, error) {
	...
	byteSize := (bitSize-checksumSize)/8 + 2
	if len(hex) != byteSize {
...
func validateEntropyBitSize(bitSize int) error {
	if (bitSize%32) != 0 || bitSize < 128 || bitSize > 512 {
		return errors.New("Entropy length must be [128, 512] and a multiple of 32")
	}
	return nil
}

func validateEntropyWithChecksumBitSize(bitSize int) error {
	if (bitSize != 128+4) && (bitSize != 160+5) && (bitSize != 192+6) && (bitSize != 224+7) && (bitSize != 256+8) && (bitSize != 512+16) {
...
func IsMnemonicValid(mnemonic string) bool {
	...
	if numOfWords < 12 || numOfWords > 48 || numOfWords%3 != 0 {
		return false
	}
