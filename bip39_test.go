...
func TestBip39(t *testing.T) {
	for _, vector := range testVectors() {
		...
		// randBytes := []byte("hellowhuefnuahuhfoniquxwhenfoiuqwnoiefwoifuhwosjdhflkjashdflajhsdfiehfiou")
		// entropy512 := sha512.Sum512(randBytes[:64])
		log.Printf("Entropy %s", hex.EncodeToString(entropy[:]))
		mnemonic, err := NewMnemonic(entropy[:])
		assert.NoError(t, err)
		assert.Equal(t, vector.mnemonic, mnemonic)
		log.Printf("%s", vector.seed)
...
func badMnemonicSentences() []Vector {
	return []Vector{
		...
		{
			mnemonic: "zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo",
		},
	}
}
...
func testVectors() []Vector {
	return []Vector{
		{
			entropy:  "1a859271f56ecb97787ce1ac1d675cea4ef8936f486c9170b11de20847898f0ba1390bc4f50c658a25958ef3c97b92e7ddbe5c24d816a6c058e9a0352459533f",
			mnemonic: "box clutch organ turn uncover slight tiger order project twenty strong stand usage endless rule assault multiply machine electric series love shadow destroy injury decorate funny diary boat flavor barrel file taxi siren symptom rigid rocket total bar gate state scare shrug gym heart easily praise wolf gas",
			seed:     "f0e10f586ed4eb5cc439eae56ccd58cfd85101554cd1e1dcd87c372359f7ebdd4b7cde65c54abe28ca837b465203c2111830dee82e386d3f041e1db91a9f41c9",
		},
		{
